...
| OLMoE-1B-7B-0924 Q4_0 | metal | **91.23** ±0.1 | **142.02** ±0.2 | 🔴 **~1.56×** | 🔴 **llama** | ok | [`olmoe_q4_metal`](receipts/pins/olmoe_q4_metal.json) |
...
2. OLMoE Metal ~1.56× (hoisted resident + fused down×topk sum); CPU ~1.38× (flat mul_mat_id GEMV + interleaved fair-chat — llama ±5 was thermal). Next: closer Q4_0 `mul_mv_id` vs ggml + `mul_mm_id` prefill (`docs/ROADMAP.md`).
