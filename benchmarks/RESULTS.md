...
| Llama-3.2-1B-Instruct Q4_K_M | metal | **139.39** ±1.6 | **139.94** ±1.5 | ⚪ **1.00×** | ⚪ tie | ok | [`llama32_1b_q4km_metal`](receipts/pins/llama32_1b_q4km_metal.json) |
...
| Llama-3.1-8B-Instruct Q4_K_M | metal | **27.98** ±1.0 | **28.73** ±1.0 | 🔴 **~1.03×** | 🔴 **llama** | ok | [`llama31_8b_q4km_metal`](receipts/pins/llama31_8b_q4km_metal.json) |
...
| Mistral-7B-Instruct-v0.2 Q4_K_M | cpu | **3.10** ±0.5 | **3.19** ±1.2 (−ngl 0) | 🔴 **~1.03×** | 🔴 **llama** | ok | [`mistral_7b_q4km_cpu`](receipts/pins/mistral_7b_q4km_cpu.json) |
...
| Gemma-2-2B-IT Q4_K_M | metal | **58.08** ±0.6 | **58.85** ±4.4 | ⚪ **1.00×** | ⚪ tie | ok | [`gemma2_2b_q4km_metal`](receipts/pins/gemma2_2b_q4km_metal.json) |
...
| Phi-3-mini-4k-Instruct Q4 | metal | **46.98** ±2.4 | **48.43** ±0.4 | 🔴 **~1.03×** | 🔴 **llama** | ok | [`phi3_mini_q4_metal`](receipts/pins/phi3_mini_q4_metal.json) |
