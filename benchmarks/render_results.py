...
def main() -> None:
    ...
    lines.append(
        ...
        "2. OLMoE Metal ~1.56× (hoisted resident + fused down×topk sum); "
        "CPU ~1.38× (flat mul_mat_id GEMV + interleaved fair-chat — llama "
        "±5 was thermal). Next: closer Q4_0 `mul_mv_id` vs ggml + "
        "`mul_mm_id` prefill (`docs/ROADMAP.md`).\n"
