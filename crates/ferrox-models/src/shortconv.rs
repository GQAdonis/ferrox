...
//!
//! In the layer's [`ferrox_core::KvCache`], as ONE "KV head" of width
...
//! (`n_embd_r()`, `llama-hparams.cpp:189-192`); ferrox keeps the whole
...
//! and a window on the conv layer would also arm `FERROX_KV_WINDOW`'s
