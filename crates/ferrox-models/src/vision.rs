...
//! decoder's embedding space. Genuinely new territory for ferrox, which
...
//!    (`(x[i], x[i+dim/2])`) `ferrox_core::attention::apply_rope`
...
/// decode-step primitives in `ferrox_core::attention`.
