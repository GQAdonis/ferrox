...
//!     crates/ferrox-models/tests/fixtures/cohere2moe_tiny.gguf [--rms | --mtp | --norm-w]
//! /tmp/ref_logits crates/ferrox-models/tests/fixtures/cohere2moe_tiny.gguf 3 7 11 19 23 5
//! ```
...
use ferrox_models::norm::{NormFunction, NormOp};
...
/// byte-identical to the trunk-only file's, and so are ferrox's.
#[test]
