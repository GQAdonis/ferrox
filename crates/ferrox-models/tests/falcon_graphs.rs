...
//!   (`ferrox_models::parallel_residual`, `SharedNorm`; `:71-74,124-135`)
...
//!     crates/ferrox-models/tests/fixtures/falcon_tiny.gguf
//! PYTHONPATH=$LLAMA/gguf-py python3 scripts/make_falcon_fixture.py \
//!     crates/ferrox-models/tests/fixtures/falcon_40b_tiny.gguf --40b
...
use ferrox_models::norm_sites::ATTN_NORM_2_FEEDS_ATTENTION;
