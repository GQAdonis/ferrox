...
//! (its logits differ from `lfm2`'s) and ferrox refuses it by name.
//!
//! ```text
//! PYTHONPATH=$LLAMA/gguf-py python3 scripts/make_lfm2_fixture.py \
//!     crates/ferrox-models/tests/fixtures/lfm2_tiny.gguf [--fused-qkv | --output | --window]
//! /tmp/ref_logits crates/ferrox-models/tests/fixtures/lfm2_tiny.gguf 3 7 11 19 23 5
//! ```
...
use ferrox_models::{Decoder, LoadError, ModelConfig};
