...
//!     crates/ferrox-models/tests/fixtures/jamba_tiny.gguf --arch jamba
//! /tmp/ref_logits crates/ferrox-models/tests/fixtures/jamba_tiny.gguf 3 7 11 19 23 5
//! ```
...
use ferrox_models::mamba1::DtBcNorm;
...
fn each_seam_is_visible_in_the_logits() {
    ...
    let ferrox_models::ssm_block::SsmBlock::Mamba1(m) = m else {
    ...
    let ferrox_models::ssm_block::SsmBlock::Mamba1(m) = d.layers[0].attn.ssm.as_mut().unwrap()
    else {
        unreachable!()
    };
    m.dt_bc_norm = saved;
