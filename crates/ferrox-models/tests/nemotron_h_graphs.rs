...
//!     crates/ferrox-models/tests/fixtures/nemotron_h_tiny.gguf [--biases | --output]
//! /tmp/ref_logits crates/ferrox-models/tests/fixtures/nemotron_h_tiny.gguf 3 7 11 19 23 5
//! ```
...
use ferrox_models::config::{FfnActivation, RopeLayout};
...
fn a_block_without_an_ffn_still_reaches_the_residual() {
    ...
    let zero = ferrox_core::weight_matrix::WeightMatrix::F32(ferrox_core::Tensor::new(
