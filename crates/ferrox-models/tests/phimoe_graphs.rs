...
//!     crates/ferrox-models/tests/fixtures/phimoe_tiny.gguf
//! PYTHONPATH=$LLAMA/gguf-py python3 scripts/make_phimoe_fixture.py \
//!     crates/ferrox-models/tests/fixtures/phimoe_plain_tiny.gguf --no-longrope
...
use ferrox_models::proj_bias::{Presence, ATTN_OUT_BIAS_CREATORS, OUTPUT_BIAS_CREATORS};
