...
//! absolute position table (`ferrox_models::position_embd`) added to the
...
//! biases with the ungated GELU (`ferrox_models::proj_bias`), a
...
//!     crates/ferrox-models/tests/fixtures/gpt2_tiny.gguf
//! PYTHONPATH=$LLAMA/gguf-py python3 scripts/make_gpt2_fixture.py \
//!     crates/ferrox-models/tests/fixtures/starcoder_tiny.gguf --starcoder
...
use ferrox_models::position_embd::{learned_positions, LEARNED_POSITION_CREATORS};
use ferrox_models::proj_bias::Presence;
