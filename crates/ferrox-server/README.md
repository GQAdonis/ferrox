...
`FERROX_CORS_ORIGINS=<that exact origin>`. The `*` wildcard is refused
on purpose — a wildcard beside a bearer token is a credential-leak
shape. See [`docs/CONFIG.md`](../../docs/CONFIG.md).
