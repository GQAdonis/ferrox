...
Usage:
    PYTHONPATH=/path/to/llama.cpp/gguf-py \\
        python3 scripts/make_nemotron_h_fixture.py OUT.gguf [--biases] [--output]
...
def main(out_path: str, biases: bool, separate_output: bool) -> None:
    n_layer = len(LAYERS)
    ...
    w.add_name("ferrox-nemotron_h-fixture")
    ...
    w.close()
    print(f"wrote {out_path} (layers {LAYERS}, biases={biases}, output={separate_output})")
